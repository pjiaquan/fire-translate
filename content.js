...
async function showBubble(text, selection) {
  ...
  bubble.innerHTML = `
    <div class="bubble-header">
      ...
      <button type="button" aria-label="Close Popup" class="bubble-close" title="Close Popup">&times;</button>
    </div>
...
function setupFooter(bubble, textToCopy) {
  ...
  footer.innerHTML = `
    <button type="button" aria-label="Copy Translation" class="bubble-copy-btn" title="Copy Translation">
