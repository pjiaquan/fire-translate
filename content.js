...
async function showBubble(text, selection) {
  ...
  bubble.innerHTML = `
    <div class="bubble-header">
      ...
      <button class="bubble-close" title="Close Popup" aria-label="Close Popup" type="button">&times;</button>
    </div>
...
function setupFooter(bubble, textToCopy) {
  ...
  footer.innerHTML = `
    <button class="bubble-copy-btn" title="Copy Translation" type="button">
